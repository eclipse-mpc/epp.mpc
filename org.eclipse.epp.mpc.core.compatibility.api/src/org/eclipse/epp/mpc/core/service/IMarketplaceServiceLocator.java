...
public interface IMarketplaceServiceLocator {
	 ...
	 */
	//FIXME Migrate property
	@SuppressWarnings("deprecation")
	public static final String DEFAULT_MARKETPLACE_PROPERTY_NAME = "org.eclipse.epp.internal.mpc.core.service.MarketplaceService.url"; //$NON-NLS-1$
